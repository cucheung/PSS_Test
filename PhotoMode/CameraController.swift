...
// Camera Controller class to store Camera settings
...
extension CameraController {
    ...
    func prepare(completionHandler: @escaping (Error?) -> Void) {
        ...
        func configureCaptureDevices() throws {
            ...
            // Throw error if camera does not exist
    ...
    func captureImage(completion: @escaping (UIImage?, Error?) -> Void) {
        ...
        let settings = [AVCapturePhotoSettings(),AVCapturePhotoSettings(),AVCapturePhotoSettings(),AVCapturePhotoSettings(),AVCapturePhotoSettings(), AVCapturePhotoSettings()]
        // CMPT275 - loop through the settings in array and capture a picture every 0.5 sec (total of 6 pictures)
